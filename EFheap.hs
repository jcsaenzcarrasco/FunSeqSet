...
import qualified Data.Edison.Coll.LazyPairingHeap as S
...
type TreeEF   a = FingerTree (S.Heap (a,a)) (a,a)
...
newtype FT a    = FT {getFT :: (FingerTree (S.Heap (a,a)) (TreeEF a))} 
 deriving Show
...
instance (Ord a) => Measured (S.Heap (a,a)) (a,a) where 
...
edgeIn :: (Measured (S.Heap a) b, Ord a)
       => a
       -> FingerTree (S.Heap a) b       
       -> Bool
